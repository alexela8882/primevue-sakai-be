...
use App\Models\Core\{Entity, Field};
...
class EntityField {
    ...
    public function resolveEntity($entity, $currentUserAllowed = true) {
        ...
        else if(is_object($entity) && $entity instanceof Entity){
            return $entity;
        }
        else {
    ...
    public function checkInstanceFieldValue($entity, $entityInstance, $smartFieldName, $requireFieldType = null, $checked = false){
        ...
        else if($requireFieldType && $field->fieldType->name == 'picklist' && $value) {
