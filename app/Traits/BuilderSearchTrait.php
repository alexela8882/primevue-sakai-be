            ...
            $builder = $builder->where(function ($query) use ($fields, $searchString, $searchStrings, $entityName) {
                foreach ($fields as $field) {
                    ...
                    if ($field->fieldType->name == 'lookupModel') { // || $field->groupWith
                        ...
                        list($criteriaFilters, $filterLogic) = $this->getSearchFilterInfo($fieldNames, $searchString, $searchStrings);
                        ...
                        //if ($result && count($result)) {
                            $query->orWhere(function ($q) use ($whereField, $result, $field) {
                    ...
                    } else if ($field->fieldType->name == 'picklist') {
